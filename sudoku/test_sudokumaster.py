from sudokumaster import validation, generate_board, get_board, print_board, generate_reason,generate_hint_reason, numbers_possible, display_error_message
import pytest
...
def test_display_error_message_valid(capfd):
    message = "Invalid move! Try again."
    expected_output = f"Error: {message}\n"
    display_error_message(message)
    captured = capfd.readouterr()
    assert captured.out == expected_output

def test_display_error_message_different_message(capfd):
